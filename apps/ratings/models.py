...
from pstore.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    author = models.ForeignKey(Profile, verbose_name=_("Author being rated"), related_name="author_review", on_delete=models.SET_NULL, null=True)
    ...
    class Meta:
        unique_together = ["rater", "author"]

    def __str__(self):
        return f"{self.author} rated at {self.rating}"
